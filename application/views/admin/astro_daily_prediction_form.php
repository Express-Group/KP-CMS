...
<?php
//print_r($fetch_values);exit;
if(isset($fetch_values['prediction_id']) && $fetch_values['prediction_id'] != '' )
{
	$title1 = 'Astrology Daily predictions - Edit';
}else{ $title1 = 'Astrology Daily predictions - Create';}
...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		<?php } ?>
		<form name="dailyPredictions_form" id="dailyPredictions_form" action="<?php echo base_url(folder_name); ?>/astro_daily_prediction/add_daily_predictions" method="post" enctype="multipart/form-data">
			<div class="BodyHeadBg Overflow clear">
				...
				<a class="FloatLeft back-top" href="<?php echo base_url(folder_name); ?>/astro_daily_prediction"><i class="fa fa-reply fa-2x"></i></a>
					...
					<div class="section_form">
							...
							<div class="panchangam-sec1">
							    <div class="panchangam-date1">
									<div class="qns">
										<label class="question" style="text-align:left;">Date<span id="mandatory">*</span></label>
									</div>
	...
	<script type="text/javascript" src="<?php echo $script_url; ?>js/jquery.remodal.js"></script>
	 <script language="javascript">
		...
		$("#preview_id").click(function() {
			...
			var postdata = {"body_text" :body_text,"date": date,"rasi_name":raasi_name,"menu_name":'<?php echo 'Astrology Daily Prediction'; ?>'};
			$.ajax({
