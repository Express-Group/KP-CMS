        ...
        <ul class="nav navbar-nav menus">
          ...
          <li class="AllSectionHover" id="AllSectionHoverId"><a class="MenuItem" href="javascript:void(0);">All Sections &nbsp;<i class="fa fa-chevron-down"></i></a>
            <div class="MultiSection">
              ...
              <div class="MultiSectionList" style="width: 15%;"> <a class="AllTopic" href="<?php echo base_url()."cities"; ?>"><?php echo "Cities"; ?></a> <a class="AllList" href="<?php echo base_url()."cities/chennai"; ?>"><?php echo "Chennai"; ?></a> <a class="AllList" href="<?php echo base_url()."cities/delhi"; ?>"><?php echo "Delhi"; ?></a><a class="AllList" href="<?php echo base_url()."cities/bengaluru"; ?>"><?php echo "Bengaluru"; ?></a> <a class="AllList" href="<?php echo base_url()."cities/hyderabad"; ?>"><?php echo "Hyderabad"; ?></a> <a class="AllList" href="<?php echo base_url()."cities/kochi"; ?>"><?php echo "Kochi"; ?></a> <a class="AllList" href="<?php echo base_url()."cities/thiruvananthapuram"; ?>"><?php echo "Thiruvananthapuram"; ?></a> </div>
              ...
              <div class="MultiSectionList" style="width: 18%;"> <a class="AllTopic" href="<?php echo base_url()."todays-paper"; ?>" rel="nofollow" target="_blank"><?php echo "Today's Paper"; ?></a> <a class="AllTopic" href="http://www.edexlive.com/" rel="nofollow" target="_blank"><?php echo "Edex"; ?></a> <a class="AllTopic" href="http://www.indulgexpress.com/" rel="nofollow" target="_blank"><?php echo "Indulge"; ?> </a> <a class="AllTopic" href="http://www.eventxpress.com" rel="nofollow" target="_blank">Event Xpress </a> <a class="AllTopic" href="<?php echo base_url()."magazine"; ?>"><?php echo "Magazine"; ?></a> <a class="AllTopic" href="<?php echo base_url()."thesundaystandard"; ?>"><?php echo "The Sunday Standard"; ?></a> <a class="AllTopic" href="http://epaper.newindianexpress.com" rel="nofollow" target="_blank"><?php echo "E-paper"; ?> </a> </div>
            </div>
          </li>
        </ul>
      </div>
