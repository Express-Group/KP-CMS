...
{
$widget_custom_title = "Galleries";
}
$show_simple_tab     = "";
$show_simple_tab    .='<div class="row">
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bottom-space-10">
			           <div class="gallery GalleryVideo" '.$widget_bg_color.'>
...
//$widget_instance_contents = $this->widget_model->get_RightSide_Galleries('2', $widget_instancemainsection[$j]['Section_ID'], $content['mode'],'114');	
...
if(count($widget_contents)>0)
{
	...
	<a  href="'.$live_article_url.'" class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'" width="600" height="390">
	<img class="GalleryIcon" data-src="'.$play_gallery_image.'" src="'.image_url.'images/FrontEnd/images/social-icon-set/social_icon.png"></a>
