...
{	
	...
	<a   href="'.$live_article_url.'"><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'" width="600" height="390">
	<img class="GalleryIcon" data-src="'.$play_video_image.'" src="'.image_url.'images/FrontEnd/images/social-icon-set/social_icon.png"></a>
