...
$show_simple_tab    .='<div class="row">
                       ...
                       <div class="MagazinesVoices features MagazinesVoice-upgraded" '.$widget_bg_color.'>';
...
else
{
   ...
   if($render_mode == "manual")
	    ...
	    if($original_image_path != ''  && getimagesize(image_url_no . imagelibrary_image_path .$original_image_path))
			{
				$imagedetails = getimagesize(image_url_no . imagelibrary_image_path.$original_image_path);
...
if($i==1)
{
$show_simple_tab.=	'<div class="MagazinesVoice">';
}

$show_simple_tab.=	'<div class="MagazinesVoiceItem"><span class="VoiceContTopic"><a href="'.$url_section_value.'" >'.$author_name.'</a></span><div class="MagazinesVoiceImg"><a  href="'.$live_article_url.'" class="article_click"  ><img  data-src="'.$show_image.'" src="'.$dummy_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'" width="150" height="150"></a></div><div class="MagazinesVoiceCont"><p> '.$display_title.'
</p></div></div>';
