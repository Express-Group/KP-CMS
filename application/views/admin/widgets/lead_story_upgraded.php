...
$show_simple_tab        .='<div class="margin-bottom-10 lead_stories features lead_stories_upgraded" '.$widget_bg_color.' id="lead_stori_'.$widget_instance_id.'">';
	// widget title 
	...
	{
		if(trim($widget_custom_title) != '' && trim($widget_custom_title)!='none')
	...
	if(count($widget_instance_contents)>0)
	{
		...
		$dummy_image	= image_url. imagelibrary_image_path.'logo/nie_logo_600X390.jpg';		
				...
				$show_simple_tab .='<div class="item '.$add_active.'">
									<h4 class="subtopic subtop"><a  href="'.$live_article_url.'"  class="article_click" >'.$display_title.'</a></h4><a  href="'.$live_article_url.'"  class="article_click" >'.$img_icon.'<img class="img-over"  src="'.$dummy_image.'" data-src="'.$show_image.'"  title = "'.$imagetitle.'" alt = "'.$imagealt.'" width="600" height="390"></a>';
