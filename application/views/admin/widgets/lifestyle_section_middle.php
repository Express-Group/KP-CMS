...
$show_simple_tab      = "";
$show_simple_tab .='<div style="background:none;" class="nation" id="nation_'.$widget_instance_id.'" '.$widget_bg_color.'>
						  <div class="nation1"  style="background:none;">';	
...
$show_simple_tab .='<div  style="background:none;" class="common_p NationContent '.$border_class.'" >';
}
